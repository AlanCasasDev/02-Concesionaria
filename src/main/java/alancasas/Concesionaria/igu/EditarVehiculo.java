...
public class EditarVehiculo extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(EditarVehiculo.class.getName());
    ...
    private void initComponents() {
        ...
        label_titulo.setText("Editar Vehiculo");
    ...
    private void btn_volverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_volverActionPerformed
        ConsultaVehiculo consult = new ConsultaVehiculo(); //Creo instancia de la ventana principal                
        consult.setVisible(true); //Hago la ventana principal visible
        consult.setLocationRelativeTo(null); //Que aparezca en el medio
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        if (validarFormulario()) {
            if (!confirmarAccion("¿Desea guardar el registro modificado?", "Confirmación")) {
                return;
            }

            //Guardo los valores del form en una variable
            ...
            //Busco y guardo el vehiculo que quiero editar
            Vehiculo vehi = controlLogic.buscarVehiculo(id);
            ...
            switch (color.toUpperCase()) {
                case "AMARILLO":
                    vehi.setColor(EnumColor.AMARILLO);
                    break;
                case "AZUL":
                    vehi.setColor(EnumColor.AZUL);
                    break;
                case "BLANCO":
                    vehi.setColor(EnumColor.BLANCO);
                    break;
                case "GRIS":
                    vehi.setColor(EnumColor.GRIS);
                    break;
                case "NEGRO":
                    vehi.setColor(EnumColor.NEGRO);
                    break;
                case "ROJO":
                    vehi.setColor(EnumColor.ROJO);
                    break;
                case "VERDE":
                    vehi.setColor(EnumColor.VERDE);
                    break;
                case "VIOLETA":
                    vehi.setColor(EnumColor.VIOLETA);
                    break;
                default:
                    vehi.setColor(EnumColor.BLANCO);
            }

            switch (cantPuertas.toUpperCase()) {
                case "2":
                    vehi.setCantPuertas(EnumCantPuertas.DOS_PUERTAS);
                    break;
                case "3":
                    vehi.setCantPuertas(EnumCantPuertas.TRES_PUERTAS);
                    break;
                case "4":
                    vehi.setCantPuertas(EnumCantPuertas.CUATRO_PUERTAS);
                    break;
                case "5":
                    vehi.setCantPuertas(EnumCantPuertas.CINCO_PUERTAS);
                    break;
                default:
                    vehi.setCantPuertas(EnumCantPuertas.DOS_PUERTAS);
            }

            if (controlLogic.editarVehiculo(vehi)) {
                mostrarMensaje("Se edito correctamente", "info", "Titulo");
                ...
                mostrarMensaje("ERROR: No se pudo guardar la entidad editada", "error", "Titulo");
            }
    ...
    public static void main(String args[]) {
        ...
        //java.awt.EventQueue.invokeLater(() -> new EditarVehiculo().setVisible(true));
    }
    ...
    private void cargarDatosAlForm(int id) {
        Vehiculo vehi = controlLogic.buscarVehiculo(id);
        /*Setear el formulario con los datos del vehiculo*/
        txt_modelo.setText(vehi.getModelo());
        txt_marca.setText(vehi.getMarca());
        txt_patente.setText(vehi.getPatente());

        switch (vehi.getColor().getDescription().toUpperCase()) {
            case "AMARILLO":
                combo_color.setSelectedIndex(1);
                break;
            case "AZUL":
                combo_color.setSelectedIndex(2);
                break;
            case "BLANCO":
                combo_color.setSelectedIndex(3);
                break;
            case "GRIS":
                combo_color.setSelectedIndex(4);
                break;
            case "NEGRO":
                combo_color.setSelectedIndex(5);
                break;
            case "ROJO":
                combo_color.setSelectedIndex(6);
                break;
            case "VERDE":
                combo_color.setSelectedIndex(7);
                break;
            case "VIOLETA":
                combo_color.setSelectedIndex(8);
                break;
            default:
                combo_color.setSelectedIndex(0);
        }

        switch (vehi.getCantPuertas().getDescription()) {
            case 2:
                combo_puertas.setSelectedIndex(1);
                break;
            case 3:
                combo_puertas.setSelectedIndex(2);
                break;
            case 4:
                combo_puertas.setSelectedIndex(3);
                break;
            case 5:
                combo_puertas.setSelectedIndex(4);
                break;
            default:
                combo_puertas.setSelectedIndex(0);
        }
